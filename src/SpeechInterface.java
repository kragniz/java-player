 ...
 *
 * $Id: SpeechInterface.java 132 2011-05-04 00:04:49Z corot $
 *
 */
package javaclient3;
...
public class SpeechInterface extends PlayerDevice {
    ...
    public void speech (String text) {
        ...
        if (text.length () > PLAYER_SPEECH_MAX_STRING_LEN)
            temp = text.substring (0, PLAYER_SPEECH_MAX_STRING_LEN - 1) + '\0';
        try {
            int leftOvers = 0;
            ...
            xdr.xdrEncodeInt  (temp.length ());  // count also the ending '\0'
