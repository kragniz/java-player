 ...
 *
 * $Id: BumperInterface.java 125 2011-03-24 02:24:05Z corot $
 *
 */
package javaclient3;
...
public class BumperInterface extends PlayerDevice {
    ...
    private void readGeom () {
        try {
            ...
            buffer = new byte[bumpersDefCount * 56];
            // Read bumper geometry values
            is.readFully (buffer, 0, bumpersDefCount * 56);
