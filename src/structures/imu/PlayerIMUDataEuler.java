...
public class PlayerIMUDataEuler implements PlayerConstants {
    ...
    // Calibrated IMU data (acceleration, gyroscope, magnetometer)
    ...
    /**
     * @return Calibrated IMU data (acceleration, gyroscope, magnetometer)
     */
    ...
    /**
     * @param newCalib_data Calibrated IMU data (acceleration, gyroscope, magnetometer)
     */
