 ...
 * The imu interface returns calibrated acceleration, gyroscope and magnetic values
 * from the IMU sensor.
...
public class PlayerIMUDataCalib implements PlayerConstants {
    ...
    // The IMU's calibrated gyroscope value on X-axis.
    private float gyro_x;
    // The IMU's calibrated gyroscope value on Y-axis.
    private float gyro_y;
    // The IMU's calibrated gyroscope value on Z-axis.
    ...
    /**
     * @return The IMU's calibrated gyroscope value on X-axis.
     */
    ...
    /**
     * @param newGyro_x The IMU's calibrated gyroscope value on X-axis.
     */
    ...
    /**
     * @return The IMU's calibrated gyroscope value on Y-axis.
     */
    ...
    /**
     * @param newGyro_y The IMU's calibrated gyroscope value on Y-axis.
     */
    ...
    /**
     * @return The IMU's calibrated gyroscope value on Z-axis.
     */
    ...
    /**
     * @param newGyro_z The IMU's calibrated gyroscope value on Z-axis.
     */
