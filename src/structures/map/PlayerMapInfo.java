 ...
 *
 * $Id: PlayerMapInfo.java 125 2011-03-24 02:24:05Z corot $
 *
 */
...
public class PlayerMapInfo implements PlayerConstants {
     ...
     *          cell (0,0) in the map
     */
    public synchronized PlayerPose2d getOrigin () {
        return this.origin;
    }
     ...
     *                   cell (0,0) in the map
     */
    public synchronized void setOrigin (PlayerPose2d newOrigin) {
