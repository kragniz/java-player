 ...
 *
 * $Id: LaserInterface.java 167 2011-11-16 04:31:29Z corot $
 *
 */
package javaclient3;
 ...
 * @deprecated Use {@link RangerInterface ranger} instead.
...
public class LaserInterface extends PlayerDevice {
   ...
   public boolean isDataScanposeReady () {
    ...
    public void setScanProperties (PlayerLaserConfig plc) {
        try {
            sendHeader (PLAYER_MSGTYPE_REQ, PLAYER_LASER_REQ_SET_CONFIG, 28);
            ...
            xdr.xdrEncodeFloat (plc.getFrequency  ());
            xdr.endEncoding ();
        ...
        try {
            switch (header.getSubtype ()) {
                ...
                case PLAYER_LASER_REQ_GET_CONFIG: {
                    ...
                    plconfig.setFrequency  (xdr.xdrDecodeFloat ());
                    xdr.endDecoding   ();
                    xdr.close ();
