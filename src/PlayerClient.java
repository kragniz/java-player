 ...
 *
 * $Id: PlayerClient.java 150 2011-08-22 14:39:57Z corot $
 *
 */
package javaclient3;
...
//    private long    timeout = 100;
    ...
    /**
     * The PlayerClient constructor. Once called, it will create a socket with the
     * Player server running on host <b>servername</b> on port <b>portNumber</b>.
...
/*        } catch (IOException e) {
    ...
    private PlayerDevice requestSatisfy (PlayerDevAddr devAddr, byte access,
        ...
        switch (devAddr.getInterf ()) {
            ...
            case PLAYER_AUDIO_CODE: {               // audio system
                newpd = new AudioInterface (this);
                break;
            }
            ...
            case PLAYER_CAMERA_CODE: {              // camera device
            ...
            case PLAYER_SPEECH_RECOGNITION_CODE: {  // speech recognition interface
                newpd = new SpeechRecognitionInterface (this);
                break;
            }
            case PLAYER_OPAQUE_CODE: {              // opaque interface
            	newpd = new OpaqueInterface (this);
                break;
            }
            case PLAYER_POSITION1D_CODE: {          // 1-D position interface
            ...
            case PLAYER_STEREO_CODE: {              // Stereo interface
                newpd = new StereoInterface (this);
                break;
            }
            default: {
                logger.log (Level.WARNING, "[PlayerClient]: " +
...
/*    /**
     ...
     */
    public AudioInterface requestInterfaceAudio (int index, int access) {
     ...
     */
    public StereoInterface requestInterfaceStereo (int index, int access) {
