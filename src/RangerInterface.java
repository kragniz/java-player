 ...
 *
 * $Id: RangerInterface.java 144 2011-08-22 14:16:10Z corot $
 *
 */
package javaclient3;
        ...
        try {
            switch (header.getSubtype ()) {
                case PLAYER_RANGER_REQ_GET_GEOM: {
                    ...
                    // Buffer for reading entire ranger device pose and size
                    ...
                    // Read ranger sizes
                    is.readFully (buffer, 0, sizesCount * 24);
                    xdr = new XdrBufferDecodingStream (buffer);
                    xdr.beginDecoding ();
