 ...
 *
 * $Id: PlannerInterface.java 125 2011-03-24 02:24:05Z corot $
 *
 */
package javaclient3;
...
public class PlannerInterface extends PlayerDevice {
        ...
        try {
            switch (header.getSubtype ()) {
                case PLAYER_PLANNER_DATA_STATE: {
                    ...
                    PlayerPose2d waypoint = new PlayerPose2d ();
     ...
     */
    public void setGoal (PlayerPose2d goal) {
        try {
        ...
        try {
            switch (header.getSubtype ()) {
                case PLAYER_PLANNER_REQ_GET_WAYPOINTS: {
                    ...
                    // Read waypoints_count, array_count
                    ...
                    xdr.beginDecoding ();
                    PlayerPose2d[] waypoints = new PlayerPose2d[waypointsCount];
