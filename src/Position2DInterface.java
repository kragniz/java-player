 ...
 *
 * $Id: Position2DInterface.java 125 2011-03-24 02:24:05Z corot $
 *
 */
package javaclient3;
...
public class Position2DInterface extends AbstractPositionDevice {
    ...
    public synchronized void readData (PlayerMsgHdr header) {
        try {
            ...
            case PLAYER_POSITION2D_DATA_STATE:
                ...
                // Buffer for reading pos, vel and stall (24 + 24 + 4)
     ...
     */
    public void setPosition (PlayerPose2d pos, PlayerPose2d vel, int state) {
        try {
     ...
     * @param state motor state (zero is either off or locked, depending on the driver)
     */
    public void setVelocity (PlayerPose2d vel, int state) {
        try {
    ...
    private void readGeom () {
        try {
            // Buffer for reading pose and size (48 + 24)
     ...
     */
    public void setOdometry (PlayerPose2d pose) {
        try {
