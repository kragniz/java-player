 ...
 *
 * $Id: PlayerClientUtils.java 160 2011-09-06 00:39:39Z corot $
 *
 */
package javaclient3;
...
public class PlayerClientUtils implements PlayerConstants {
    ...
    public String lookupName (int code) {
        switch (code) {
            ...
            case PLAYER_HEALTH_CODE:
                return PLAYER_HEALTH_STRING;
            ...
            case PLAYER_STEREO_CODE:
                return PLAYER_STEREO_STRING;
    ...
    public short lookupCode (String name) {
        ...
        if (name.startsWith (PLAYER_HEALTH_STRING))
            return PLAYER_HEALTH_CODE;

        if (name.startsWith (PLAYER_IMU_STRING))
        ...
        if (name.startsWith (PLAYER_RANGER_STRING))
            return PLAYER_RANGER_CODE;

        if (name.startsWith (PLAYER_STEREO_STRING))
            return PLAYER_STEREO_CODE;
