 ...
 *
 * $Id: AIOInterface.java 139 2011-05-04 21:31:28Z corot $
 *
 */
package javaclient3;
        ...
        try {
            switch (header.getSubtype ()) {
                case PLAYER_AIO_DATA_STATE: {
                    ...
                    buffer = new byte[4 + voltagesCount * 4];
                    // Read voltages
                    is.readFully (buffer, 0, 4 + voltagesCount * 4);
