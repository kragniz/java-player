 ...
 *
 * $Id: XdrDecodingStream.java 125 2011-03-24 02:24:05Z corot $
 *
 */
/*
...
public abstract class XdrDecodingStream {
   ...
   /**
     ...
     * preceding length value. This way the receiver doesn't need to know
    ...
    public final long xdrDecodeLong()
           throws OncRpcException, IOException {
        //
        // Similar to xdrEncodeLong: just read in two ints in network order.
        //
